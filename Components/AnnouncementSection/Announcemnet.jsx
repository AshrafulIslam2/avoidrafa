...
function Announcemnet() {
  return (
    <div className="bg-black">
      <div className="flex mx-[150px] items-center justify-between lg:justify-center ">
        <div className="flex-wrap">
          ...
          <h1 className="md:text-[70px] lg:text-[70px] xl:text-[105px] 2xl:text-[170px]  font-medium tracking-[-6.78px] text-white leading-none">
            is out now
          </h1>
        ...
        <Image
          ...
          height={678}
          alt="avoid-rafa "
          className=" h-[500px] object-contain xl:w-[471] xl:h-[678px]"
        />
      </div>
      <TourSchedule />
    </div>
